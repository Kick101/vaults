...
__Invisi-Shell__ (Sometimes AMSI may not be blocked)
...
```powershell
Set-MpPreference -DisableIOAVProtection $true -Verbose; Set-MpPreference -DisableRealtimeMonitoring $true -Verbose
```
